 ...
 * @description 简历内容区
 */
export const Template_zh: React.FC<Props> = props => {
    ...
    <div className="template1-resume resume-content">
      <div className="basic-info">
        ...
        <div className="profile">
          {profile?.name && (
            <div className="name">{`${profile.name}(${profile.age})(${profile.sex})`}</div>
          )}
          <div className="profile-list">
            ...
            {profile?.website && (
              <div className="email">
                <GlobalOutlined style={{ color: theme.color, opacity: 0.85 }} />
                {profile.website}
              </div>
            )}
            {profile?.github && (
